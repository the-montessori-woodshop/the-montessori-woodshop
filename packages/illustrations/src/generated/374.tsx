...
const Svg374 = (
  ...
  >
    ...
    <path
      d="M253.247 409.801c2.069 52.482 114.123 149.073 236.262 97.961 56.805-23.774 48.999-53.648 89.745-97.81 24.287-26.322 60.705-47.921 68.052-83.556 6.35-30.76-2.283-62.371-20.12-81.784-40.116-43.659-115.215-69.084-179.278 11.654-64.064 80.738-199.981 18.18-194.661 153.535z"
      fill="url(#a)"
    />
    <path
      d="M252.881 206.048c11.069 19.755 35.312 22.47 74.151 18.716 29.209-2.829 55.846-5.018 85.058-20.944 20.446-11.14 36.63-26.212 48.443-40.85 12.801-15.858 30.668-33.956 21.909-51.936-12.037-24.7-81.645-45.501-149.236-11.483-74.25 37.38-91.154 87.189-80.325 106.497z"
      fill="url(#b)"
    />
    <path
    ...
    <path
      ...
      fill="url(#d)"
    />
    <circle cx={201.434} cy={455.49} r={8.814} fill="#E1E4E5" />
    <circle cx={775.453} cy={390.175} r={12.731} fill="#E1E4E5" />
    <circle cx={156.551} cy={368.351} r={9.689} fill="#E1E4E5" />
    ...
    <circle
      ...
      fill="#E1E4E5"
    />
    <circle cx={500.381} cy={80.338} r={8.628} fill="#E1E4E5" />
    <ellipse cx={191.817} cy={314.681} rx={9.899} ry={7.919} fill="#E1E4E5" />
    <path
      d="M685.794 101.294h-.141c-.835 11.831-9.634 12.013-9.634 12.013s9.702.19 9.702 13.861c0-13.671 9.703-13.861 9.703-13.861s-8.795-.182-9.63-12.013zm31.164 330.665h-.135c-.802 11.797-9.25 11.978-9.25 11.978s9.316.189 9.316 13.82c0-13.631 9.315-13.82 9.315-13.82s-8.444-.181-9.246-11.978z"
      fill="#E1E4E5"
    />
    <path
      d="M530.265 121.347h66.007c19.002 0 34.43 15.427 34.43 34.43v66.007M369.628 482.918h-66.007c-19.003 0-34.43-15.427-34.43-34.429v-66.007"
      stroke="#6f381e"
      strokeWidth={29.89}
      strokeLinecap="round"
...
const ForwardRef = forwardRef(Svg374);
