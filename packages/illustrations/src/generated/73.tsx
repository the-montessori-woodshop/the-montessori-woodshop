...
const Svg73 = (
  ...
  >
    ...
    <rect
      ...
      fill="#6f381e"
    />
    <circle cx={541.027} cy={170.404} r={17.9} fill="#fff" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M557.092 186.256a22.498 22.498 0 0 0 6.505-15.853 22.5 22.5 0 0 0-6.505-15.853 17.829 17.829 0 0 1 8.321-2.047c9.886 0 17.9 8.014 17.9 17.9s-8.014 17.9-17.9 17.9c-3.004 0-5.835-.739-8.321-2.047z"
      fill="#fff"
    />
    <rect
      x={312.993}
    ...
    <rect
      ...
      fill="#6f381e"
    />
    <circle cx={541.027} cy={484.181} r={17.9} fill="#fff" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M557.092 500.034a22.498 22.498 0 0 0 6.505-15.853 22.5 22.5 0 0 0-6.505-15.853 17.829 17.829 0 0 1 8.321-2.047c9.886 0 17.9 8.014 17.9 17.9s-8.014 17.9-17.9 17.9c-3.004 0-5.835-.74-8.321-2.047z"
      fill="#fff"
    />
    <rect
      x={312.993}
    ...
    <rect
      ...
      fill="#6f381e"
    />
    <circle cx={625.239} cy={327.293} r={17.9} fill="#fff" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M641.305 343.144a22.498 22.498 0 0 0 6.504-15.853 22.5 22.5 0 0 0-6.505-15.853 17.829 17.829 0 0 1 8.321-2.047c9.886 0 17.9 8.014 17.9 17.9s-8.014 17.9-17.9 17.9c-3.004 0-5.835-.74-8.32-2.047z"
      fill="#fff"
    />
    <rect
      x={397.206}
...
const ForwardRef = forwardRef(Svg73);
