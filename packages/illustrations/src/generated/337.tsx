...
const Svg337 = (
  ...
  >
    ...
    <circle
      ...
      cy={203.62}
      r={7.283}
      transform="rotate(180 792.026 203.62)"
      fill="#6f381e"
    />
    <circle
      cx={449.697}
      cy={446.697}
      r={13.697}
      transform="rotate(180 449.697 446.697)"
      fill="#6f381e"
    />
    <circle
      r={10.873}
      transform="matrix(-1 0 0 1 189.283 487.553)"
      fill="#6f381e"
    />
    <circle
      r={7.279}
      transform="matrix(-1 0 0 1 760.498 280.034)"
      fill="#6f381e"
    />
    <circle
      r={13.519}
      transform="matrix(-1 0 0 1 70.42 493.544)"
      fill="#E1E4E5"
    />
    <circle
      r={10.289}
      transform="matrix(-1 0 0 1 802.872 499.053)"
      fill="#E1E4E5"
    />
    <circle
      r={12.933}
      transform="matrix(-1 0 0 1 686.933 121.933)"
      fill="#E1E4E5"
    />
    <circle
      r={10.272}
      transform="scale(1 -1) rotate(-75 -76.66 -236.798)"
      fill="#E1E4E5"
    />
    <circle
      r={13.665}
      transform="matrix(-1 0 0 1 288.607 121.496)"
      fill="#E1E4E5"
    />
    <ellipse
      rx={10.512}
      ry={8.409}
      transform="matrix(-1 0 0 1 742.265 375.375)"
      fill="#E1E4E5"
    />
    <circle
      r={16.777}
      transform="matrix(0 1 1 0 607.777 109.777)"
      fill="#E1E4E5"
    />
    <path
      d="M189.829 134.419h.15c.887 12.563 10.23 12.757 10.23 12.757s-10.303.201-10.303 14.718c0-14.517-10.303-14.718-10.303-14.718s9.34-.194 10.226-12.757zm9.132 403.081h.144c.851 12.527 9.822 12.72 9.822 12.72s-9.892.2-9.892 14.674c0-14.474-9.892-14.674-9.892-14.674s8.967-.193 9.818-12.72z"
      fill="#E1E4E5"
    />
    <path
      d="M451.131 366.558c-111.537 0-111.537 113.604-158.726 87.361-35.735-19.874-44.597-91.842-36.464-189.437 8.133-97.595 41.825-125.48 125.479-125.48h144.784c83.653 0 111.753 41.827 120.117 125.48 8.364 83.652-.001 156.348-36.464 189.437s-47.189-87.361-158.726-87.361z"
      fill="#6f381e"
    />
    <path
      d="M367.477 208.713V320.25m-55.769-55.768h111.538"
      stroke="#fff"
      strokeWidth={20.913}
      strokeLinejoin="round"
    />
    <circle cx={506.898} cy={292.366} r={27.884} fill="#fff" />
    <circle cx={562.667} cy={236.597} r={27.884} fill="#fff" />
    <defs>
      <linearGradient
        id="a"
        x1={466.28}
...
const ForwardRef = forwardRef(Svg337);
