...
const Svg317 = (
  ...
  >
    ...
    />
    <path
      d="M828.038 361.81c-10.697 5.306-24.895-1.517-24.895-1.517s3.156-15.423 13.858-20.722c10.697-5.306 24.889 1.509 24.889 1.509s-3.155 15.424-13.852 20.73z"
      fill="url(#b)"
    />
    <path
      d="M79.319 356.324c15.62 9.362 38.03.707 38.03.707s-2.931-23.829-18.56-33.18c-15.62-9.362-38.02-.718-38.02-.718s2.93 23.829 18.55 33.191z"
      fill="url(#c)"
    />
    <circle
      cx={790.355}
      cy={204.39}
      r={7.264}
      transform="rotate(180 790.355 204.39)"
      fill="#6f381e"
    />
    <circle
      cx={638.039}
      cy={456.663}
      r={13.662}
      transform="rotate(180 638.039 456.663)"
      fill="#6f381e"
    />
    <circle
      r={10.845}
      transform="matrix(-1 0 0 1 189.124 487.61)"
      fill="#6f381e"
    />
    <circle
      r={7.261}
      transform="matrix(-1 0 0 1 758.906 280.612)"
      fill="#6f381e"
    />
    <circle
      r={13.485}
      transform="matrix(-1 0 0 1 70.56 493.587)"
      fill="#E1E4E5"
    />
    <circle
      r={10.263}
      transform="matrix(-1 0 0 1 801.174 499.081)"
      fill="#E1E4E5"
    />
    <circle
      r={12.9}
      transform="matrix(-1 0 0 1 688.414 128.04)"
      fill="#E1E4E5"
    />
    <circle
      r={10.246}
      transform="scale(1 -1) rotate(-75 -77.144 -237.05)"
      fill="#E1E4E5"
    />
    <circle
      r={13.631}
      transform="matrix(-1 0 0 1 288.199 122.472)"
      fill="#E1E4E5"
    />
    <ellipse
      rx={10.485}
      ry={8.388}
      transform="matrix(-1 0 0 1 740.718 375.714)"
      fill="#E1E4E5"
    />
    <circle
      r={21.324}
      transform="scale(1 -1) rotate(-75 258.682 -421.188)"
      fill="#E1E4E5"
    />
    <path
      d="M189.669 135.362h.15c.884 12.532 10.204 12.725 10.204 12.725s-10.277.201-10.277 14.681c0-14.48-10.278-14.681-10.278-14.681s9.317-.193 10.201-12.725zm9.109 402.07h.144c.849 12.495 9.797 12.688 9.797 12.688s-9.867.2-9.867 14.637c0-14.437-9.868-14.637-9.868-14.637s8.945-.193 9.794-12.688z"
      fill="#E1E4E5"
    />
    <path
      d="M334.096 157.493c-8.874 93.556-8.494 193.803.011 283.783 1.551 16.417 15.468 28.757 31.958 28.757h167.288c16.606 0 30.579-12.511 32.014-29.056 7.938-91.515 8.03-191.703.025-283.216-1.445-16.527-15.41-29.013-32-29.013H366.054c-16.486 0-30.401 12.333-31.958 28.745z"
      fill="#6f381e"
      stroke="#6f381e"
      strokeWidth={24.378}
    ...
    />
    <path
      d="M449.471 335.957V177.503m60.944 36.566h-60.944m36.566 60.944h-36.566"
      stroke="#fff"
      strokeWidth={22.352}
      strokeLinejoin="round"
    />
    <circle
      ...
      cy={372.523}
      r={36.566}
      transform="rotate(-90 449.471 372.523)"
      stroke="#fff"
      strokeWidth={22.352}
    />
    <defs>
...
const ForwardRef = forwardRef(Svg317);
