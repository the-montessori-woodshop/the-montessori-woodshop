...
const Svg252 = (
  ...
  >
    ...
    />
    <path
      d="M471.021 368.748a2.894 2.894 0 0 1 2.893 2.893"
      stroke="#fff"
      strokeWidth={41.748}
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M89.809 318.049c16.815-8.342 39.134 2.384 39.134 2.384s-4.96 24.245-21.785 32.575c-16.816 8.342-39.125-2.372-39.125-2.372s4.96-24.246 21.776-32.587z"
      fill="url(#b)"
    />
    <path
      d="M813.849 251.536c-15.569-9.331-37.906-.705-37.906-.705s2.921 23.751 18.499 33.072c15.57 9.331 37.897.716 37.897.716s-2.921-23.752-18.49-33.083z"
      fill="url(#c)"
    />
    <circle
      r={9.533}
      transform="matrix(1 0 0 -1 278.198 94.81)"
      fill="#E1E4E5"
    />
    <circle
      r={13.77}
      transform="matrix(1 0 0 -1 686.005 132.297)"
      fill="#E1E4E5"
    />
    <circle
      r={10.48}
      transform="matrix(1 0 0 -1 99.143 141.618)"
      fill="#E1E4E5"
    />
    <circle
      r={10.463}
      transform="matrix(0 -1 -1 0 792.763 470.649)"
      fill="#E1E4E5"
    />
    <circle
      r={13.919}
      transform="matrix(1 0 0 -1 618.51 507.354)"
      fill="#E1E4E5"
    />
    <ellipse
      rx={10.707}
      ry={8.566}
      transform="matrix(1 0 0 -1 201.409 234.864)"
      fill="#E1E4E5"
    />
    <circle
      r={13.345}
      transform="scale(-1 1) rotate(-75 172.299 410.654)"
      fill="#E1E4E5"
    />
    <path
      d="M777.546 169.359h-.146c-.868-12.759-10.005-12.955-10.005-12.955s10.076-.204 10.076-14.947c0 14.743 10.076 14.947 10.076 14.947s-9.134.196-10.001 12.955z"
      fill="#E1E4E5"
    />
    <defs>
      <linearGradient
...
const ForwardRef = forwardRef(Svg252);
