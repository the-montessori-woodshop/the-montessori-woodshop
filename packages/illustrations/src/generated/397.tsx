...
const Svg397 = (
  ...
  >
    ...
    <circle
      ...
      cy={123.975}
      r={7.839}
      transform="rotate(180 771.563 123.975)"
      fill="#6f381e"
    />
    <circle
      cx={790.578}
      cy={269.601}
      r={14.742}
      transform="rotate(180 790.578 269.601)"
      fill="#6f381e"
    />
    <circle
      r={11.703}
      transform="matrix(-1 0 0 1 137.703 428.703)"
      fill="#6f381e"
    />
    <circle
      r={7.835}
      transform="matrix(-1 0 0 1 257.254 189.309)"
      fill="#6f381e"
    />
    <circle
      r={14.551}
      transform="matrix(-1 0 0 1 163.938 348.678)"
      fill="#E1E4E5"
    />
    <circle
      r={11.074}
      transform="matrix(-1 0 0 1 573.323 479.519)"
      fill="#E1E4E5"
    />
    <circle
      r={13.92}
      transform="matrix(-1 0 0 1 674.154 131.158)"
      fill="#E1E4E5"
    />
    <circle
      r={11.056}
      transform="scale(1 -1) rotate(-75 -80.998 -219.43)"
      fill="#E1E4E5"
    />
    <circle
      r={14.708}
      transform="matrix(-1 0 0 1 265.382 48.273)"
      fill="#E1E4E5"
    />
    <ellipse
      rx={11.314}
      ry={9.051}
      transform="matrix(-1 0 0 1 778.952 377.799)"
      fill="#E1E4E5"
    />
    <circle
      r={18.058}
      transform="matrix(0 1 1 0 498.835 344.479)"
      fill="#E1E4E5"
    />
    <path
      d="M184.34 118.446h.161c.955 13.523 11.012 13.731 11.012 13.731s-11.09.217-11.09 15.842c0-15.625-11.09-15.842-11.09-15.842s10.053-.208 11.007-13.731zm-35.394 362.109h.154c.917 13.483 10.572 13.69 10.572 13.69s-10.647.216-10.647 15.795c0-15.579-10.647-15.795-10.647-15.795s9.651-.207 10.568-13.69z"
      fill="#E1E4E5"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M405.056 55.584H257.037c-32.564 0-59.207 26.643-59.207 59.207v148.018c0 32.565 26.643 59.208 59.207 59.208h148.019c32.564 0 59.207-26.643 59.207-59.208V114.791c0-32.564-26.643-59.207-59.207-59.207z"
      fill="#6f381e"
      stroke="#6f381e"
      strokeWidth={31}
      strokeLinecap="round"
    ...
    />
    <path
      d="M730.696 300.009H553.074m177.622-102.604H553.074M730.696 94.802H553.074m177.622 410.414H197.83m532.866-102.604H197.83"
      stroke="#6f381e"
      strokeWidth={31}
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="m310.325 144.401 47.366 44.405-47.366 44.406"
      stroke="#fff"
      strokeWidth={31}
      strokeLinecap="round"
      strokeLinejoin="round"
...
const ForwardRef = forwardRef(Svg397);
